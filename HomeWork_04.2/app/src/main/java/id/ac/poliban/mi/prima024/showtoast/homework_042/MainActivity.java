package id.ac.poliban.mi.prima024.showtoast.homework_042;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) getSupportActionBar().setTitle("Checkboxes and etc_024 PRIMA-E020320024/04.3");
    }
