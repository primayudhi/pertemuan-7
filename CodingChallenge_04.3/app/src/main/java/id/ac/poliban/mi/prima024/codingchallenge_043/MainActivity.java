package id.ac.poliban.mi.prima024.codingchallenge_043;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) getSupportActionBar().setTitle("Context Menu Scrolling Text_024 PRIMA-E020320024");
